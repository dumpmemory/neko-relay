...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build                     -ldflags="-w -s" -o build/neko-relay_linux_amd64
# echo "build darwin amd64..."
# CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build                    -ldflags="-w -s" -o build/neko-relay_darwin_amd64
...
# CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build                     -ldflags="-w -s" -o build/neko-relay_linux_arm64
# echo "build darwin arm64..."
# CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build                    -ldflags="-w -s" -o build/neko-relay_darwin_arm64

# echo "build linux 386..."
# CGO_ENABLED=0 GOOS=linux GOARCH=386 go build                       -ldflags="-w -s" -o build/neko-relay_linux_386
...
# CGO_ENABLED=0 GOOS=linux GOARCH=arm GOARM=7 go build               -ldflags="-w -s" -o build/neko-relay_linux_arm7
# echo "build linux amd6..."
# CGO_ENABLED=0 GOOS=linux GOARCH=arm GOARM=6 go build               -ldflags="-w -s" -o build/neko-relay_linux_arm6
# echo "build linux amd5..."
# CGO_ENABLED=0 GOOS=linux GOARCH=arm GOARM=5 go build               -ldflags="-w -s" -o build/neko-relay_linux_arm5

# echo "build linux mips..."
# CGO_ENABLED=0 GOOS=linux GOARCH=mips go build                      -ldflags="-w -s" -o build/neko-relay_linux_mips
# echo "build linux mipsle..."
# CGO_ENABLED=0 GOOS=linux GOARCH=mipsle go build                    -ldflags="-w -s" -o build/neko-relay_linux_mipsle
# echo "build linux mips_softfloat..."
# CGO_ENABLED=0 GOOS=linux GOARCH=mips GOMIPS=softfloat go build     -ldflags="-w -s" -o build/neko-relay_linux_mips_softfloat
# echo "build linux mipsle_softfloat..."
# CGO_ENABLED=0 GOOS=linux GOARCH=mipsle GOMIPS=softfloat go build   -ldflags="-w -s" -o build/neko-relay_linux_mipsle_softfloat
# echo "build linux mips64 ..."
# CGO_ENABLED=0 GOOS=linux GOARCH=mips64 go build                    -ldflags="-w -s" -o build/neko-relay_linux_mips64
# echo "build linux mips64le ..."
# CGO_ENABLED=0 GOOS=linux GOARCH=mips64le go build                  -ldflags="-w -s" -o build/neko-relay_linux_mips64le
# echo "build linux mips64_softfloat ..."
# CGO_ENABLED=0 GOOS=linux GOARCH=mips64 GOMIPS=softfloat go build   -ldflags="-w -s" -o build/neko-relay_linux_mips64_softfloat
